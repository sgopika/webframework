...
<div class="row ">
 ...
 <div class="col-12 py-1 px-2 ">
  ...
  <div class="col-12 py-1">
       ...
       @if(Auth::user()->usertypes_id==2)
        <a href="{{ route('appadmin.staffcommitteecreate') }}"><button type="button" class="btn btn-sm  text-white bg-magenta fg-lighTaupe eng_xxxs"  id="transactionbutton" name="transactionbutton"> <i class="fas fa-plus-square "></i>&nbsp;Add New</button></a>
         @elseif(Auth::user()->usertypes_id==9)
         <a href="{{ route('appmanager.staffcommitteecreate') }}"><button type="button" class="btn btn-sm  text-white bg-magenta fg-lighTaupe eng_xxxs"  id="transactionbutton" name="transactionbutton"> <i class="fas fa-plus-square "></i>&nbsp;Add New</button></a>
         @endif
