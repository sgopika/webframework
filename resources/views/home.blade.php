            ...
            <div class="col-3 py-3">
                ...
                <div class="card-body  ">
                    <blockquote class="blockquote ">
                        <p class="mb-0 font-weight-bold eng_xxs fg-darkOlive">Module Name</p>
                    ...
                    <div class="d-flex align-items-center align-self-end">
                        ...
                        <div class="meta-item ml-auto">
                             <a href="" class="fg-darkGrayBlue nolink btn btn-sm bg-lightGray px-3 eng_xxxs"> <i class="fas fa-arrow-alt-circle-right"></i> View </a>
                        </div>
                    </div>
                 </div> <!-- ./card-body -->
                </div> <!-- ./card -->
