        ...
        <div id="form_section">
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                ...
                <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="entitle" name="entitle" aria-describedby="HELPNAME" placeholder="Name" maxlength="1000" minlength="3"></textarea>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
               ...
               <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle" name="maltitle" aria-describedby="HELPNAME" placeholder="Name" maxlength="1000" minlength="3"></textarea>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="url" name="url" aria-describedby="HELPNAME" placeholder="Name" maxlength="300" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                 <input type="text" name="livestreamingdate" id="livestreamingdate" value="{{ Carbon\Carbon::now()->format('d/m/Y')  }}" class="form-control customform eng_xxxs fg-darkCrimson dob" required>
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a Livestreaming with same name exists");
