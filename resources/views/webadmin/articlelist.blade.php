...
<div class="row ">
  ...
  <div class="col-12 py-1 px-2 ">
    <p class="eng_xxs px-3 fg-darkBrown"> Article List </p>
  </div> <!-- ./col12 -->
               ...
               @php
                ...
                <tr>
                    ...
                    <td><span class="eng_xxxxs"> {{ $res['maltitle'] }} </span> </td>
                  	<td><span class="eng_xxxxs bg-info px-2 py-2 uplddet" id="{{ $res['id'] }}"> {{ $res['artupldcnt'] }} </span> </td>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modalover">
       ...
       @if(Auth::user()->usertypes_id==3)
      <form action="{{ route('siteadmin.articlestore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
         @elseif(Auth::user()->usertypes_id==4)
      <form action="{{ route('webadmin.articlestore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
      @elseif(Auth::user()->usertypes_id==5)
      <form action="{{ route('editor.articlestore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
      @endif
        @csrf
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <select class="form-control customform eng_xxxs fg-darkCrimson" id="components_id" name="components_id" required></select>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            <div class="col-md-6 py-2">
          ...
          <div class="row customformrow">
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">Extras </label>
              
            </div> <!-- ./col-md-6 -->
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="extras" name="extras" aria-describedby="HELPNAME" placeholder="Name" maxlength="150" minlength="3">
                <p id="extraserror" style="display:none; color:#FF0000;" >Only A -Z a-z Characters are allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            <div class="col-md-6 py-2">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modalover">
       ...
       @if(Auth::user()->usertypes_id==3)
      <form action="{{ route('siteadmin.articleupdate') }}" id="ajaxmodalform1" method="post" class="form-horizontal" enctype="multipart/form-data">
         @elseif(Auth::user()->usertypes_id==4)
      <form action="{{ route('webadmin.articleupdate') }}" id="ajaxmodalform1" method="post" class="form-horizontal" enctype="multipart/form-data">
      @elseif(Auth::user()->usertypes_id==5)
      <form action="{{ route('editor.articleupdate') }}" id="ajaxmodalform1" method="post" class="form-horizontal" enctype="multipart/form-data">
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="extras1" name="extras1" aria-describedby="HELPNAME" placeholder="Name" maxlength="150" minlength="3">
                <p id="extraserror1" style="display:none; color:#FF0000;" >Only A -Z a-z Characters are allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            <div class="col-md-6 py-2">
       ...
       success:function(data)
        {
            ...
            $('#articlecategories_id').append($('<option></option>').val('').html('Select'));
       ...
       success:function(data)
        { 
          ...
          $('#components_id1').empty();
            $('#components_id1').append($('<option></option>').val('').html('Select'));
            $.each(data.component, function(index, element) {
                $('#components_id1').append(
                    $('<option></option>').val(element.id).html(element.entitle)
                );
              element.id == data.resultdata.components_id ? $('#components_id1').val(element.id).prop('selected', true) : '';
            });

            $('#articlecategories_id1').empty();
            $('#articlecategories_id1').append($('<option></option>').val('').html('Select'));
            $.each(data.articlecategory, function(index, element) {
                $('#articlecategories_id1').append(
                    $('<option></option>').val(element.id).html(element.entitle)
                );
                element.id == data.resultdata.articlecategories_id ? $('#articlecategories_id1').val(element.id).prop('selected', true) : '';
            });
