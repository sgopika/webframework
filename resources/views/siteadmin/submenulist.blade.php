...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
            ...
            <div class="col-md-6 py-2">
                <select class="form-control customform eng_xxxs fg-darkCrimson" id="mainmenuid" name="mainmenuid" ></select>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            <div class="col-md-6 py-2">
 ...
 <div class="row customformrow">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="pointto" name="pointto" aria-describedby="HELPNAME" placeholder="Placeholder value">
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
