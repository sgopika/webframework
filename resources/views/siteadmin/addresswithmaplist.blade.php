      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="maplink" name="maplink" aria-describedby="HELPNAME" placeholder="Map Link" ></textarea>
                <p id="maplinkerror" style="display:none; color:#FF0000;" >Only A -Z a-z Characters are allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
      ...
      $.ajax({
       ...
       success:function(data)
        { 
          ...
          $('#maplink').val(data.resultdata.maplinks);
