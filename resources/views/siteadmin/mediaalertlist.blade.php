          ...
          <div class="row customformrow">
           ...
           <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                ...
                <p id="enbrieferror" style="display:none; color:#FF0000;" >Only A -Z a-z Characters are allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">Malayalam Brief</label>
              <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Enter the Malayalam Brief.</small>
            </div> <!-- ./col-md-6 -->
            <div class="col-md-6 py-2">
              ...
              <textarea class="summernote" id="malbrief" name="malbrief" aria-describedby="HELPNAME" placeholder="Name" maxlength="1000" minlength="3"></textarea>
       ...
       success:function(data)
        {
            ...
            $('#contenttypes_id').append($('<option></option>').val('0').html('Select'));
      ...
      $.ajax({
       ...
       success:function(data)
        { 
          ...
          $('#alttext').val(data.resultdata.alttext);
           ...
           $('#contenttypes_id').empty();
            ...
            $.each(data.contenttype, function(index, element) {
                $('#contenttypes_id').append(
                 ...
                 element.id == data.resultdata.contenttypes_id ? $('#contenttypes_id').val(element.id).prop('selected', true) : '';
            });
            ...
            $.each(data.menutype, function(index, element) {
                $('#filetypes_id').append(
                 ...
                 element.id == data.resultdata.filetypes_id ? $('#filetypes_id').val(element.id).prop('selected', true) : '';
            });
