        ...
        <div id="form_section">
         ...
         <div class="row customformrow">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
               <!--  <textarea class="form-control customform eng_xxxs fg-darkCrimson" ></textarea> -->
               ...
               <p id="malcontenterror" style="display:none; color:#FF0000;" >Only Malayalam Characters are allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
  ...
  $(document).on('click', '.edit', function(){
      ...
      $.ajax({
       ...
       success:function(data)
        { 
          if(data.error){
            alert("The What's New is Locked, So cannot be edited!");
          } else {   
