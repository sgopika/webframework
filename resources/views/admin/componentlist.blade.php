...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Name">
...
<div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="order" name="order" aria-describedby="HELPNAME" placeholder="Order number">
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already an component with same name exists");
