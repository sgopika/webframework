    ...
    <nav aria-label="breadcrumb" class="breadcrumbinner py-1 eng_xxxs">
      <ol class="breadcrumb justify-content-end px-3 pt-2">
        ...
        @if(Auth::user()->usertypes_id==14)
         ...
         <li class="breadcrumb-item"><a class="no_link" href="{{ route('depthead.appdepartment') }}">Department Details</a></li>
        ...
        <li class="breadcrumb-item"><a class="no_link" href="{{ route('deptsohome') }}"><i class="fas fa-home"></i>&nbsp;Home</a></li>
         <li class="breadcrumb-item"><a class="no_link" href="{{ route('deptso.appdepartment') }}">Department Details</a></li>
        @endif 
      </ol>
...
$(document).on('click', '.verify', function(){
      ...
      var action_url = '';
      if(usertype==14){
         action_url = "/depthead/appdepartmentview/"+id;

      } else if(usertype==16){
         action_url = "/deptso/appdepartmentview/"+id;
      } 
      $.ajax({
         url: action_url,
         dataType:"json",
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url1 = '';
    if(usertype==14){
       action_url1 = "{{ route('depthead.contributedactupdate') }}";
    } else if(usertype==16){
       action_url1 = "{{ route('deptso.contributedactupdate') }}";
    } 
