...
<div class="row ">
    ...
    <div class="col-12 py-1 px-2 ">
        <p class="eng_xxs px-3 fg-darkBrown"> App Client Dashboard </p>
    </div> <!-- ./col12 --> 
    <div class="col-12 ">
        <div class="row">
                ...
                <div class="card-body  ">
                    ...
                    <div class="d-flex align-items-center align-self-end">
                        ...
                        <div class="meta-item ml-auto">
                             <a href="{{ route('appclient.communicationlist') }}" class=" nolink btn btn-sm widgetbutton px-3 eng_xxxs"> <i class="fas fa-arrow-alt-circle-right"></i> View </a>
                        </div>
                    </div>
                 </div> <!-- ./card-body -->
                </div> <!-- ./card -->
