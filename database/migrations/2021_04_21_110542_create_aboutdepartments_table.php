...
class CreateAboutdepartmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('aboutdepartments', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('aboutdepartments');
    }
}
